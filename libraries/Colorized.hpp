...
namespace colorized {
    ...
    static void PrintWith(const std::string color, const std::string text) {
   		std::cout << color << text << WBLACK_COLOR;
    }

    static void PrintWhReset(const std::string color, const std::string text) {
    	std::cout << color << text;
    }
    ...
    static const std::string ColorizeChar(int type, int color) {
